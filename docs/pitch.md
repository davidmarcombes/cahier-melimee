...
> S'occuper des enfants, un point c'est tout.

---

# Le Pourquoi ?

### **Quand on a un problème on cherche des solutions**

❌ **Les écarts se creusent** – Les études le montrent, les parents le voient.
❌ **Barrière aux outils** – Cahiers, sites, abonnements: tout coûte.
...
### **Offrir aux enfants un outil de travail des maths**

✅ **Gratuit** – Pas d’abonnement, pas de mode premium.
✅ **Sans pub, sans tracking** – On ne vend rien, on ne prélève rien.
✅ **Anonyme** – Zéro collecte de données.
✅ **Souverain** – Hébergé et conçu en France.
✅ **Hors ligne ou en ligne** – Téléchargeable en un clic.
✅ **Complémentaire à l’école** – Exercices alignés sur les programmes.

---

# La Philosophie 🌟

### **Un outil pédagogique qui respecte les enfants (et les parents !)**

🔹 **Des exercices classiques et ciblés** – Concentration sur les fondamentaux.
...
💙 La répétition espacée → Revoir régulièrement les notions pour ancrer durablement.

💙 Progression graduelle → Du simple vers le complexe, sans saut brutal.

💙 Feedback immédiat → L’erreur devient un repère, pas une sanction.

💙 Rituel quotidien de 5 à 15 minutes → Mieux vaut peu mais souvent.

💙 Tout le monde progresse → Chacun son rythme et son niveau.
...
- [x] Prototype exercices fonctionnel (630+ séries, 44 types, du CP au CM2).
- [x] Prototype backend et inscription.
- [x] Design minimaliste et mascotte Salto.
- [ ] **Finaliser la version bêta** (tests utilisateurs).
- [ ] **Trouver des complices** (dev, design, pédagogie).
- [ ] **Création contenu** (contributeurs / IA)
...
👉 **Contradicteurs** (Chasseurs de trous dans la raquette).
👉 **Développeurs** (JS/HTML/CSS, PocketBase).
👉 **Designers** (Salto, Mélimée, UI, charte, police).
