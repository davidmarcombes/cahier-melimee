...
const CASES = [
  ...
  [
    ...
    () =>
      abacusSvg([
        { label: 'milliers', value: 3 },
        { label: 'centaines', value: 7 },
      ]),
  ],
...
console.log(
  'Function'.padEnd(COL.name) + 'Raw'.padStart(COL.raw) + 'Opt'.padStart(COL.opt) + 'Saved'.padStart(COL.pct)
);
